...
#endif
*/
extern "C" volatile char keyboard_map[128];
#define keyb keyboard_map

extern "C" int           keyboard_chain_flag;
extern "C" int           keyboard_init(void);
extern "C" void          keyboard_close(void);

extern "C" inline void   keyboard_chain(void) { keyboard_chain_flag = 1; }
extern "C" inline void   keyboard_unchain(void) { keyboard_chain_flag = 0; }
extern "C" inline int    keyboard_key_down(int scan) { return (int)keyboard_map[scan]; }
